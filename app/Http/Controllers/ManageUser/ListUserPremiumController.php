...
class ListUserPremiumController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(auth()->user()->isAdmin()) {
            ...
            $data = User::where([['parent_id', '=', auth()->user()->id], ['user_group_id', '=', 3]])->whereIn('status_id', $status_id)->SearchPaginateAndOrder($request);
        }
        ...
        $site_options['sub_name'] = 'User List : Premium';
