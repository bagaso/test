...
class DistributorController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = User::select('id', 'fullname', 'contact', 'user_group_id', 'credits', 'distributor', 'status_id')->where([['distributor', 1], ['status_id', 2], ['credits', '>', 0]])->SearchDistPaginateAndOrder($request);
