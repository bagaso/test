...
class AddServerController extends Controller
{
    ...
    public function addServer(Request $request)
    {
        ...
        $response = $client->request('POST', '/client/v4/zones/5e777546f7645f3243d2290ca7b9c5af/dns_records',
            ['headers' => ['X-Auth-Email' => 'mp3sniff@gmail.com', 'X-Auth-Key' => 'ff245b46bd71002891e2890059b122e80b834', 'Content-Type' =>'application/json'], 'form_params' => json_encode(array('type' => 'A', 'name' => $request->server_domain, 'content' => $request->server_ip))]);
